...
class Loss_Tracker:
        _perceptibility_loss: float = 0.0
        _detection_loss: float = 0.0
        ...
        def update_perceptibility_loss(self, loss):
                ...
                self._perceptibility_loss = (self._perceptibility_loss * 0.99) + (loss * 0.01)
        ...
        def update_detection_loss(self, loss):
                ...
                self._detection_loss = (self._detection_loss * 0.99) + (loss * 0.01)
...
def record_attack_training_data(attack, training_data_path, step_number):
        training_data = {}
